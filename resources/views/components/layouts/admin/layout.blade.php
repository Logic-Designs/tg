...
<head>
    ...
    <link rel="icon" type="image/png" href="{{url('images/main/logo.png')}}">
    <!-- CSS files -->
    @if(app()->getLocale() == 'ar')
    <link href="{{url('tabler/dist/css/tabler.rtl.min.css')}}" rel="stylesheet" />
    @else
    ...
    <link href="{{url('tabler/dist/css/tabler-vendors.min.css')}}" rel="stylesheet" />
    <link href="{{url('tabler/dist/css/demo.min.css')}}" rel="stylesheet" />
    <!-- <link href="{{ url('admin/dataTables/datatables.min.css') }}" rel="stylesheet"> -->

</head>

<body dir="{{ app()->getLocale() == 'ar'?'rtl': 'ltr' }}">
    <div class="wrapper">
        <x-layouts.admin.header :admin="$admin" />
        ...
        <script src="{{url('tabler/dist/js/demo.min.js')}}"></script>
        <script src="{{url('tabler/dist/libs/ckeditor-5.js') }}"></script>
        <script>
